...
public class QuestLogUI : MonoBehaviour
{
    ...
    private void ShowUI()
    {
        ...
        // Verificar configuração do InputManager e descomentar a linha abaixo se necessário
        //InputManager.GetInstance().EnterMenuMode();
    ...
    private void HideUI()
    {
        ...
        // Verificar configuração do InputManager e descomentar a linha abaixo se necessário
        //InputManager.GetInstance().EnterGameplayMode();
